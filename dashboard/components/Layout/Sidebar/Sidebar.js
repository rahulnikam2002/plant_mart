...
export const Sidebar = () => {
    ...
    const [activeTab, setActiveTab] = useState(
        router.asPath.split("/")[1].toLocaleLowerCase().length === 0 ? "dashboard" : router.asPath.split("/")[1].toLocaleLowerCase()
    );
    ...
    useEffect(() => {
        setActiveTab(router.asPath.split("/")[1].toLocaleLowerCase().length === 0 ? "dashboard" : router.asPath.split("/")[1].toLocaleLowerCase());
    }, [router]);
                    ...
                    {menuData &&
                        menuData.map((menu, index) => (
                            <div
                                ...
                                key={index}
                                className={[styles.singleMenuItem, menu.menu?.toLowerCase() === activeTab?.toLowerCase() && styles.activeMenu].join(
                                    " "
                                )}>
                                ...
                                <AnimatePresence>
                                    {menu.subMenu && showDropDownMenu && showDropIndex === index && (
                                        <motion.div
